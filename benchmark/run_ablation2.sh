...
mv blockwise_kernel_32b.h blockwise_kernel.h
cd ../common
mv epilogue.h epilogue_128b.h
mv epilogue_32b.h epilogue.h
cd ../../../../build
make clean
...
cd ./include/spatha/block_sparse/spmm/
mv blockwise_kernel.h blockwise_kernel_32b.h
mv blockwise_kernel_128b.h blockwise_kernel.h
cd ../common
mv epilogue.h epilogue_32b.h
mv epilogue_128b.h epilogue.h
cd ../../../../build
make clean
cmake .. -DCMAKE_BUILD_TYPE=Debug -DCUDA_ARCHS="86" && make -j 16
cd ..
