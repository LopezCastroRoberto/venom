...
//template<> float Sputnik_Spmm<float, float>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_);
template class Sputnik_Spmm<__half, __half>;
//template<> float Sputnik_Spmm<__half, __half>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_);
template class Sputnik_Spmm<int8_t, int8_t>;
//template<> float Sputnik_Spmm<int8_t, int8_t>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_);