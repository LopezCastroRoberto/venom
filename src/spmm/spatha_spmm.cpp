...
/* template<class T>
inline float Spatha<T>::spmm(int times){
    return 0.0f;
} */
...
:Spmm_CNN<T,T2>(d){
    ...
    // if(!f) { } // parent is not a Format_cvs instance
...
float Spatha<T,T2>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_){
    ...
    //std::cout << "spatha time: " << time << std::endl;
...
/* template<>
inline float Spatha<float>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_){
...
/* template<> float Spatha<float>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_); */
//template<> float Spatha<float>::spmm(int times);

template class Spatha<half,half>;
/* template<> float Spatha<half>::spmm(int times, int bm_, int bn_, int bk_, int wm_, int wn_, int wk_, int mm_, int mn_, int mk_, int nstage_); */
//template<> float Spatha<half>::spmm(int times);
