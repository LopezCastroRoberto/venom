...
fig, axes = plt.subplots(2,4, figsize=(8,3), gridspec_kw={'hspace': 0.1, 'wspace': 0.0}, sharey='row', sharex='col') # Create matplotlib figure

df = pd.read_csv("../result/spmm_bert_spatha.csv")

df['sparsity'] = (100-100*(df['nn_row']/df['mm_col']))

df.loc[df.algo==3, "sparsity"] = 0.5
...
fig.tight_layout()
#plt.savefig('spmm_spatha.pdf', bbox_inches = 'tight')
plt.show()