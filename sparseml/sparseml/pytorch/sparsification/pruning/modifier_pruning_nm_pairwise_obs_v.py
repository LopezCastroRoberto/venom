...
__all__ = [
    "OBSnmvpairPruningModifier",
    "OBSnmvpairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class OBSnmvpairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.info("Initializing OBSnmvpairPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return OBSnmvpairPruningParamsScorer(
            params=params,
...
class OBSnmvpairPruningParamsScorer(PruningParamsGradScorer):
    """
